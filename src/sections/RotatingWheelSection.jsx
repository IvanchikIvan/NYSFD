...
const PHRASES = [
  ...
  "За наши тёплые созвоны",
  "За твою искренность со мной",
  "За наше особенное тепло друг к другу",
  "За Павелецкую Плазу",
  "За то, что ты всегда рядом, когда нужно",
  "За то, что я твой любимый купят",
  "За наши совместные милые фоточки",
  "За то, что ты хочешь смотреть JoJo со мной",
  "За нашу ночную прогулку",
  "За наши запечатлённые на фото глазки",
  "За то, что я твой зам. мэр",
  "За Парк Горького",
